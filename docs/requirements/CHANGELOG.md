...
- **Independence:** every cited spec copied into `docs/specs/`. No requirement sends anyone to the
...
**Open, pending the design export:** `docs/specs/design/ATOMIC.md`, referenced by `docs/specs/IA.md`.
