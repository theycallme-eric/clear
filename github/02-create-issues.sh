#!/usr/bin/env bash
# 02 — create all 71 issues. Re-runnable: skips anything already in issue-map.txt.
...
create_issue "ENV-06" "[ENV-06] Test harness" "M0" --label "layer:infra" --label "carry:new"
create_issue "ENV-07" "[ENV-07] E2E harness + test data lifecycle" "M0" --label "layer:infra" --label "carry:new"
create_issue "DATA-01a" "[DATA-01a] Schema: catalog domain" "M0" --label "layer:data" --label "carry:rebuild"
create_issue "DATA-01b" "[DATA-01b] Schema: user baseline domain" "M0" --label "layer:data" --label "carry:rebuild"
create_issue "DATA-01c" "[DATA-01c] Schema: workout domain" "M0" --label "layer:data" --label "carry:rebuild"
create_issue "DATA-01d" "[DATA-01d] Schema: execution domain" "M0" --label "layer:data" --label "carry:rebuild"
...
create_issue "CORE-05" "[CORE-05] Accessibility contract" "M0" --label "layer:state" --label "carry:new"
...
create_issue "DS-04a" "[DS-04a] Card" "M0" --label "layer:design" --label "carry:new"
create_issue "DS-04b" "[DS-04b] Select" "M0" --label "layer:design" --label "carry:new"
create_issue "DS-04c" "[DS-04c] CollapsibleSection" "M0" --label "layer:design" --label "carry:new"
...
create_issue "GEN-02a" "[GEN-02a] Candidate resolution + retrieval" "M1" --label "layer:api" --label "carry:rebuild"
create_issue "GEN-02b" "[GEN-02b] Prompt composition + model call" "M1" --label "layer:api" --label "carry:rebuild"
create_issue "GEN-02c" "[GEN-02c] Validation, hydration, persistence" "M1" --label "layer:api" --label "carry:rebuild"
...
create_issue "GEN-05" "[GEN-05] Loading screen" "M1" --label "layer:ui" --label "carry:port"
create_issue "GEN-06" "[GEN-06] Duration plausibility check" "M1" --label "layer:api" --label "carry:new"
create_issue "SES-01a" "[SES-01a] Session lifecycle + atomic persistence" "M1" --label "layer:state" --label "carry:rebuild"
create_issue "SES-01b" "[SES-01b] Three-state reconstruction + the D6 regression test" "M1" --label "layer:state" --label "carry:rebuild"
create_issue "SES-01c" "[SES-01c] Streak derivation" "M1" --label "layer:state" --label "carry:rebuild"
...
create_issue "EXE-04a" "[EXE-04a] Ladder renderer + rung selection" "M1" --label "layer:ui" --label "carry:rebuild"
create_issue "EXE-04b" "[EXE-04b] For Time renderer" "M1" --label "layer:ui" --label "carry:rebuild"
create_issue "EXE-04c" "[EXE-04c] AMRAP renderer" "M1" --label "layer:ui" --label "carry:rebuild"
create_issue "EXE-05" "[EXE-05] Rest timer + coaching panel" "M1" --label "layer:ui" --label "carry:rebuild"
create_issue "EXE-07" "[EXE-07] Durable set logging" "M1" --label "layer:state" --label "carry:new"
...
create_issue "OVR-01a" "[OVR-01a] Load anchors" "M3" --label "layer:state" --label "carry:new"
create_issue "OVR-01b" "[OVR-01b] Progression rules" "M3" --label "layer:state" --label "carry:new"
create_issue "OVR-01c" "[OVR-01c] Review surface: suggestion + "why this number"" "M3" --label "layer:ui" --label "carry:new"
...
echo "Done. 71 issues. Map in $MAP."
