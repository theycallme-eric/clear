...
Turns `requirements/REQUIREMENTS.md` into **71 GitHub issues** with **136 native dependency
relationships**. Nothing in this folder is hand-maintained.

```
requirements/REQUIREMENTS.md      ← the only thing you edit
        │
        │  scripts/gen-issues.py
        ▼
github/02-create-issues.sh        71 create calls
github/03-wire-dependencies.sh    136 blocked-by relations
github/bodies/*.md                71 issue bodies
```
