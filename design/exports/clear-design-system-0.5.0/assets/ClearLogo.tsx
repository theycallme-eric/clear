...
export const ClearLogo = ({
  ...
  return (
    <div className={className} style={{ position: "relative", display: "inline-block" }}>
      ...
      <span style={{ position: "absolute", width: 1, height: 1, overflow: "hidden", clipPath: "inset(50%)", whiteSpace: "nowrap" }}>CLEAR</span>
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 0 8px var(--structure-a600), 0 0 20px var(--structure-a300), 0 0 40px var(--structure-a100)",
        }}
      />
    </div>
  );
...
const IconVariant = ({
  ...
  return (
    <div
      className={className}
      style={{ position: "relative", display: "inline-flex", alignItems: "center", justifyContent: "center", overflow: "hidden", width: containerSize, height: containerSize, borderRadius: 16 }}
    >
      {/* Background + border */}
      <div
        aria-hidden="true"
      ...
      <div
        ...
        style={{
          ...
          background: "var(--structure-500, var(--structure))",
          boxShadow:
            "0 0 8px var(--structure-a600), 0 0 20px var(--structure-a300)",
        }}
      />
    </div>
  );
