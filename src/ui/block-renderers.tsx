 ...
 * `rounds_completed`. `for_time` is EXE-04b's `ForTimeBlock`, which races the
 * block's cap and supplies `elapsed_seconds` and `completed_under_cap`. Every
 * other structure is still performed by `BlockPanel`: the block's identity, its
