...
- No application runtime exists yet. This repository is the issue-ready control plane for the build.
...
2. **Generation composition is specified.** `specs/generation/PROMPT_v4.md` carries the useful v3
...
The repo exists and code history is real. Issue migration remains the active operation:
...
Scripts are re-runnable and `github/issue-map.txt` is repository-specific and ignored.
